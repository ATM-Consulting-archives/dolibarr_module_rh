 ...
 */
class modValideur extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->description = "Valideur et déléguation";
	...
	function init($options='')
	{
		...
		$res = $extrafields->addExtraField('fk_user_delegation', 'Déléguation de note de frais', 'sellist', 0, '', 'user',0, 0,'', array("options"=> array('user:login:rowid'=>'statut=1')));
