	...
	print $TBS->render('./tpl/presence.tpl.php'
		...
		,array(
			...
			,'translate' => array(
				...
				'ConfirmAcceptAbsenceRequest' =>addslashes( $langs->trans('ConfirmAcceptPresenceRequest')),
				'ConfirmRefuseAbsenceRequest' =>addslashes( $langs->trans('ConfirmRefusePresenceRequest')),
