<?php
	...
	function _fiche(&$ATMdb, &$ressource) {
		...
		if ($_REQUEST["sendit"])
		{
			$upload_dir = DIR_DOC_OUTPUT.dol_sanitizeFileName($ressource->getId());
		...
		$formfile->list_of_documents($filearray, $ressource, 'ressource', '&id='.$ressource->getId(),0,$ressource->getId().'/');
