	...
	print $TBS->render('./tpl/ressource.tpl.php'
		...
		,array(
			'ressource'=>array(
				...
				,'date_achat'=>$form->calendrier('', 'date_achat', $ressource->date_achat,12, 10)
				,'date_vente'=>(empty($ressource->date_vente) || ($ressource->date_vente<=0) || ($mode=='new')) ? $form->calendrier('', 'date_vente', '' ,12, 10) : $form->calendrier('', 'date_vente', $ressource->date_vente,12 , 10)
				//,'date_garantie'=>(empty($ressource->date_garantie) || ($ressource->date_garantie<=0) || ($mode=='new')) ? $form->calendrier('', 'date_garantie', '' , 10) : $form->calendrier('', 'date_garantie', $ressource->date_garantie, 10)
			...
			,'NEmprunt'=>array(
				...
				,'date_debut'=> $form->calendrier('', 'evenement[date_debut]', $emprunt->date_debut, 10)
				,'date_fin'=> $form->calendrier('', 'evenement[date_fin]', $emprunt->date_fin, 10)
			)
			,'listeContrat'=>array(
				'liste' => $listeContrat	
			)
			,'contrat'=>array(
				...
				,'date_debut'=> $form->calendrier('', 'contrat[date_debut]', $contrat->date_debut, 10)
				,'date_fin'=> $form->calendrier('', 'contrat[date_fin]', $contrat->date_fin, 10)
