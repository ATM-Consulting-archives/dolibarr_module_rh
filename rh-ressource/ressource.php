...
function _liste(&$ATMdb, &$ressource) {
	...
	$sql.=" FROM ".MAIN_DB_PREFIX."rh_ressource as r
		(SELECT fk_rh_ressource, date_debut,date_fin,fk_user FROM ".MAIN_DB_PREFIX."rh_evenement WHERE type='emprunt' AND date_fin>=NOW() AND date_debut<=NOW()) as e ON ( e.fk_rh_ressource=r.rowid OR e.fk_rh_ressource=r.fk_rh_ressource)
