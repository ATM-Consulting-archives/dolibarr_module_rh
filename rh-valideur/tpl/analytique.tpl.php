...
<div class="fiche">
    ...
    <div class="tabBar">
		<h2>
			Liste de tous les codes analytiques
		</h2>
		...
		<div>
			...
			<table class="border" style="width:100%">			
				...
				<tr>
					...
					<td><img src="./img/delete.png"  style="cursor:pointer;" onclick="document.location.href='?fk_user=[userCourant.id]&deleteId=[analytique.id]&action=delete'"></td>
				</tr>
			</table>
